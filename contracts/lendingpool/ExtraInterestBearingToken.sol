 ...
 * @dev Forked Version of Implementation of the interest bearing token(eToken) for the extraFi Lending Pool
 * @author extraFi Team
 */
contract ExtraInterestBearingToken is IExtraInterestBearingToken, ReentrancyGuard, ERC20 {
    ...
    modifier onlyLendingPool() {
        require(msg.sender == lendingPool, Errors.LP_CALLER_MUST_BE_LENDING_POOL);
        _;
    }
        ...
        nonReentrant
    {
        ...
        emit Burn(msg.sender, receiverOfUnderlying, eTokenAmount, underlyingTokenAmount);
    }
